...
public class TunerConstants {
    ...
    private static final Current kSlipCurrent = Amps.of(120); //120
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(80))//60
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(10);  //10
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.367431640625);
